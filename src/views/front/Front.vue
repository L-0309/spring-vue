    ...
    <div style="display: flex;height: 60px; line-height: 60px;border-bottom: 1px solid #ccc">
      ...
      <div style="flex: 1;background-color: rgba(101,70,70,0.34)">
        ...
        <ul style="margin-top: 10px;margin-left: 50px" class="nav nav-tabs">
          ...
          <li class="item">
            <router-link class="list-group-item" active-class="active" to="/front/itemMusic">查看音乐</router-link>
          </li>
          <li class="item">
            <router-link class="list-group-item" active-class="active" to="/front/itemVideo">查看视频</router-link>
          </li>
          <li class="item">
            <router-link class="list-group-item" active-class="active"  to="/front/article">文章列表</router-link>
          </li>
          <li v-if="user.id" class="item">
            <router-link class="list-group-item" active-class="active"  to="/home">前往后台</router-link>
          </li>
        </ul>
      </div>
      <div style="width: 200px;background-color: #8c939d;float: left">
...
.item:hover {
  background-color: rgba(234, 156, 71, 0.22);
}
.list-group-item {
  position: relative;
  display: block;
