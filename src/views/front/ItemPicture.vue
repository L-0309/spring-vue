  ...
  data() {
    return {
      ...
      items: [
        {
          //点击打开时候的图片
          src: 'http://' + serverIp + ':8111/images/20201282863486.jpg',
          //页面显示的土图片
          thumbnail: 'http://' + serverIp + ':8111/images/20201282863486.jpg',
          //打开图片时的宽和高
          w: 600,
          h: 400,
          //打开后的标题
  ...
  methods: {
    load() {
      request.get('files/items').then(
          res => {
            this.files = res.data.filter(v => v.type === 'jpg' || v.type === 'png')
          }
      )
    }
  },
