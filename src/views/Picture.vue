    ...
    <el-row>
      <el-col :span="2">
        <el-upload style="display: inline-block"
                   ...
                   :show-file-list="pictureShow">
          <el-button size="mini" type="primary" @click="pictureShow = true">点击上传 <i class="el-icon-folder-add"></i> </el-button>
